...
<div class="cta-row">
  <a class="btn btn-primary" href="{{ '/assets/downloads/5min-advisory-council-2608.pdf' | relative_url }}" download>Read the full invitation (PDF)</a>
