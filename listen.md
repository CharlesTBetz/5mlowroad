...
<section class="section">
  ...
  {% include youtube-embed.html id="videoseries" thumb="7KG3GMpM_Ws" title="All videos from Five Minutes on the Low Road" params="list=PLK-uEjJBX11g" %}
</section>
...
<section class="section">
  ...
  {% include song-card.html title="Overture &amp; Leaderboard" description="Tanya the Tiger in all her competitive glory. Executive vice president at Pharmatech, gunning for the Chief Marketing Officer position. Steve used to be a friend." youtube="7KG3GMpM_Ws" id="leaderboard" lyrics="leaderboard" %}
  {% include song-card.html title="Earth Was the Dream" description="On the other side, in a garden where the flowers sing. More real than real… and almost impossible to leave." youtube="gyBw6DY6FuQ" id="earth-was-the-dream" lyrics="earth-was-the-dream" %}
  {% include song-card.html title="This Was You" description="The life review. A guide shows Tanya the consequences of her choices, replayed through the eyes and hearts of everyone she touched. And then, a decision." youtube="xamSmTWcajg" id="this-was-you" lyrics="this-was-you" %}
